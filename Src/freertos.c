...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(LEDFlashTask, LEDFlash_Task, osPriorityLow, 0, 128);
  LEDFlashTaskHandle = osThreadCreate(osThread(LEDFlashTask), NULL);

  /* definition and creation of detecttask */
  osThreadDef(detecttask, detect_task, osPriorityLow, 0, 128);
  ...
  osThreadDef(gimbaltask, gimbal_task, osPriorityLow, 0, 128);
